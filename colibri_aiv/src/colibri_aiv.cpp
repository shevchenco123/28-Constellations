...
//			if(colibri_serial::request_velocity_finished == true){
				...
				if(recv_data[CMD_CONTROL] == CMD_START){
					...
					aiv_position_x += (cos(aiv_angle) * dx - sin(aiv_angle) * dy);
					aiv_position_y += (sin(aiv_angle) * dx + cos(aiv_angle) * dy);
					aiv_angle += aiv_dth;
					
					cout<<"time_period:"<<time_period<<endl;
					cout<<"delta aiv_dth :"<<aiv_dth<<endl;
					cout<<"yaw :"<<aiv_angle<<endl;
					...
					odom_trans.transform.translation.x = aiv_position_x;
					odom_trans.transform.translation.y = aiv_position_y;
					...
					//set the position
					odom.pose.pose.position.x = aiv_position_x;
					odom.pose.pose.position.y = aiv_position_y;
