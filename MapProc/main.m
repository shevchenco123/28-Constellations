...
while(map_proc)
   ...
   switch op
       ...
       case 2
           ...
           if(init_flag == 0)
                [rec, center] = CalcRecParam(h);
                plot(center(1, 1), center(1, 2),'s', 'MarkerSize', 8, 'MarkerEdgeColor', 'g', 'MarkerFaceColor', 'g');
                init_flag = 1;
           end
           hold on;
       case 3
           ...
           if(fill_flag == 0)
                ...
                rectangle('Position',rec,'LineWidth',1,'FaceColor',[0.004 0.004 0.004],'EdgeColor','k');
                plot(center(1, 1), center(1, 2),'+', 'MarkerSize', 8, 'MarkerEdgeColor', 'g', 'MarkerFaceColor', 'y');
                fill_flag = 1;
           end
           hold on;
       case 4
           ...
           if(clear_flag == 0)
                ...
                rectangle('Position',rec,'LineWidth',1,'FaceColor',[0.996 0.996 0.996],'EdgeColor','k');
                plot(center(1, 1), center(1, 2),'o', 'MarkerSize', 8, 'MarkerEdgeColor', 'g', 'MarkerFaceColor', 'y');
                clear_flag = 1;
           end
           hold on;
       case 5
           ...
           if(unknown_flag == 0)
                ...
                rectangle('Position',rec,'LineWidth',1,'FaceColor',[0.804 0.804 0.804],'EdgeColor','k');
                plot(center(1, 1), center(1, 2),'*', 'MarkerSize', 8, 'MarkerEdgeColor', 'g', 'MarkerFaceColor', 'y');
                unknown_flag = 1;
           end
           hold on;
       case 6
           ...
           if(nav_flag == 0)
                [rec, center] = CalcRecParam(h);
                plot(center(1, 1), center(1, 2),'x', 'MarkerSize', 8, 'MarkerEdgeColor', 'y');
                nav_flag = 1;
           end
           hold on;
       case 9
